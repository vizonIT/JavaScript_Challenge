...
const averageDolphin1 = Math.floor((96 + 108 + 89) / 3);
// Average Score for Koalas with Data1:
// Data 1: score 88, 91 and 110
const averageKoalas1 = Math.floor((88 + 91 + 89) / 3);
console.log(`Case1`); console.log(`Dolphin: ${averageDolphin1};  Koalas: ${averageKoalas1}.`);
...
const averageDolphin2 = Math.floor((97 + 112 + 101) / 3);
// Average Score for Koalas with Bonus Data1:
// Data Bonus 1: scores 109, 95 and 123.
const averageKoalas2 = Math.floor((109 + 95 + 123) / 3);
console.log(`Case2`); console.log(`Dolphin: ${averageDolphin2}, Koalas: ${averageKoalas2}.`);
...
console.log(`Case3`); console.log(`Dolphin: ${averageDolphin3}, Koalas: ${averageKoalas3}.`);
